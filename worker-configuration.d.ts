/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfde517c168ded4c5cbb9872d7e2e40e)
// Runtime types generated with workerd@1.20250917.0 2025-07-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConversationRoom" | "UserConnection" | "MessageBroadcaster" | "DelayedMessageProcessor" | "LockCoordinator" | "DelayedMessageBuffer" | "LatestMessageCacheCoordinator";
	}
	interface Env {
		SESSIONS: KVNamespace;
		CACHE: KVNamespace;
		ENVIRONMENT: "production" | "development";
		R2_PUBLIC_URL: "https://s3.imfinethankyouandyou.com" | "http://localhost:8787";
		JWT_SECRET: string;
		CONVERSATION_ROOM: DurableObjectNamespace<import("./src/index").ConversationRoom>;
		USER_CONNECTION: DurableObjectNamespace<import("./src/index").UserConnection>;
		MESSAGE_BROADCASTER: DurableObjectNamespace<import("./src/index").MessageBroadcaster>;
		DELAYED_MESSAGE_PROCESSOR: DurableObjectNamespace<import("./src/index").DelayedMessageProcessor>;
		DELAYED_MESSAGE_BUFFER: DurableObjectNamespace<import("./src/index").DelayedMessageBuffer>;
		DISTRIBUTED_LOCK: DurableObjectNamespace<import("./src/index").LockCoordinator>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "R2_PUBLIC_URL" | "JWT_SECRET">> {}
}
