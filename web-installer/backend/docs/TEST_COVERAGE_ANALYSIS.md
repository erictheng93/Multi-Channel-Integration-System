...
### 1. **Services Layer** (业务逻辑层) - 51.54% ⚠️
...
| **MigrationRunner.ts** | 60.53% | 85.71% | 53.33% | ⚠️ 中等 | 🟡 中 |
| **CloudflareAPI.ts** | 59.88% | 81.25% | 57.14% | ⚠️ 中等 | 🟡 中 |
...
|------|-----------|-----------|------|
| **errors.ts** | 100% | 95% | ✅ 优秀 |
| **validation.ts** | 77.12% | 65.21% | ⚠️ 良好 |
...
| **数据库迁移** | ⚠️ 中等 | 6/10 | 60% 覆盖，12 个测试，缺少 schema 验证 |
| **Cloudflare API** | ⚠️ 中等 | 6/10 | 60% 覆盖，18 个测试，缺少错误处理 |
...
| 指标 | 当前值 | 行业标准 | 差距 | 评级 |
|------|--------|----------|------|------|
| **语句覆盖率** | 33.19% | 70-80% | -40% | ⚠️ 不合格 |
| **分支覆盖率** | 80.81% | 70-80% | +10% | ✅ 优秀 |
| **函数覆盖率** | 65.34% | 70-80% | -10% | ⚠️ 接近 |
