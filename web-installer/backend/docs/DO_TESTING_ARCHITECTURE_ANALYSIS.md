...
2.  **中期 (1個月)**: 必須補齊 DO 測試或建立 E2E 替代驗證
...
| **重試邏輯錯誤** |  高 |  中 (25%) |  中 |  無緩解措施 |
| **SSE 連接失敗** |  低 |  中 (20%) |  低 |  不影響部署本身 |
| **超時未處理** |  高 |  低 (15%) |  中 |  無緩解措施 |
