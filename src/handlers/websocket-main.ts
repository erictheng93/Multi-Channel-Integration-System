...
websocketHandler.use('*', async (c, next) => {
...
websocketHandler.options('*', (c) => {
  ...
  response.headers.set('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, Upgrade, Connection');
