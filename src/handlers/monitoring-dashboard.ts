...
export async function getMonitoringDashboard(c: Context<{ Bindings: Bindings }>) {
  try {
    ...
    return ApiResponse.success(c, dashboardData, 'Monitoring dashboard data retrieved');
  } catch (error) {
...
export async function updateMonitoringConfig(c: Context<{ Bindings: Bindings }>) {
  try {
    ...
    return ApiResponse.success(c, { updated: true }, 'Monitoring configuration updated');
  } catch (error) {
...
export async function triggerHealthCheck(c: Context<{ Bindings: Bindings }>) {
  try {
    ...
    return ApiResponse.success(c, health, 'Manual health check completed');
  } catch (error) {
...
export async function getMonitoringStats(c: Context<{ Bindings: Bindings }>) {
  try {
    ...
    return ApiResponse.success(c, stats, 'Monitoring statistics retrieved');
  } catch (error) {
