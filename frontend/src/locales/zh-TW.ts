...
export default {
  ...
  systemSettings: {
    ...
    advanced: {
      title: '進階設定',
      description: '調整訊息傳送、快取、會話和監控行為',
      messaging: '訊息處理',
      messageQueueSize: '訊息佇列大小',
      messageQueueSizeHint: '觸發背壓前允許排隊的最大訊息數量',
      messageTimeout: '訊息逾時 (秒)',
      messageTimeoutHint: '訊息處理逾時前的等待時間',
      caching: '快取',
      cacheExpiry: '快取過期時間 (分鐘)',
      cacheExpiryHint: '系統快取資料保持有效的時間',
      sessionExpiry: '會話過期時間 (小時)',
      sessionExpiryHint: '已驗證會話可保持活動的時間',
      features: '功能',
      enableRateLimit: '啟用速率限制',
      enableRateLimitHint: '限制過量請求以保護服務穩定性',
      enableLogging: '啟用系統日誌',
      enableLoggingHint: '記錄運行事件，便於排查問題和稽核',
      enableMetrics: '啟用效能監控',
      enableMetricsHint: '收集運行指標，用於監控和儀表板',
      recallWindow: {
        label: '訊息可撤回時間',
