  ...
  >
    ...
    <div class="flex items-center gap-4 flex-1">
      ...
      <div class="flex-1 min-w-0">
        <h3 class="m-0 mb-1.5 text-gray-800 text-[1.375rem] font-bold whitespace-nowrap overflow-hidden text-ellipsis">
          {{ team.name }}
        </h3>
        <p class="m-0 mb-3 text-gray-500 text-base leading-normal whitespace-nowrap overflow-hidden text-ellipsis">
