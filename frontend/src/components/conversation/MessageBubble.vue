          ...
          <div class="preview-header">
            <div class="preview-title">
              ...
              <span class="preview-meta">{{
                formatFileSize(previewImageAttachment?.fileSize || attachmentSize || 0)
              }}</span>
            </div>
              ...
              <button
                ...
                @click="
                  previewImageAttachment
                    ? downloadAttachment(previewImageAttachment)
                    : downloadFile()
                "
              >
                <DownloadIcon />
...
<style scoped>
  ...
  /* 🔧 FIX: 使用 max-width/max-height 而非 100% 以保持正確比例 */
  .video-preview-player {
    max-width: 100%;
    max-height: calc(85vh - 160px); /* 扣除 header 和 controls */
    width: auto;
    height: auto;
    object-fit: contain;
  }
