...
- **🏷️ Tagging System** - Flexible message and customer tagging
...
- **[Analytics API](./modules/ANALYTICS_API.md)** - ⚠️ **NEW - Previously Undocumented!**
...
- **[Collaboration API](./modules/COLLABORATION_API.md)** - ⚠️ **NEW - Previously Undocumented!**
...
- **[WebSocket API](./modules/WEBSOCKET_API.md)** - ⚠️ **Newly Unified Documentation!**
