...
| Endpoint | Method | Test Status | Notes |
|----------|--------|-------------|-------|
| `/` | POST |  MINOR ISSUE | Create message (validation difference) |
| `/:id` | GET |  PASS | Get message by ID |
| `/:id` | PUT |  PASS | Update message |
| `/:id` | DELETE |  PASS | Recall/delete message |

**Tests:**
-  Create new message (expects 201, validation issue)
-  Fail with invalid conversation ID (expectation mismatch)
...
| Endpoint | Method | Test Status | Notes |
|----------|--------|-------------|-------|
| `/search` | GET |  2/3 PASS | Advanced message search |

**Tests:**
-  Search messages by content (query structure issue)
...
|---------------|--------|-------|
| Malformed JSON |  ISSUE | Expectation mismatch |
| Non-existent IDs |  PASS | 404 error handling |
| Required fields |  ISSUE | Validation difference |
