...
This project is indexed by GitNexus as **Multi-Channel-Integration-System** (55392 symbols, 89189 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
